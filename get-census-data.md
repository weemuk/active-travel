...
Search for census data with
https://www.google.com/search?q=census+2011+middle+super+output+area+data+travel+to+work

From
https://statistics.ukdataservice.ac.uk/dataset/method-travel-work-england-and-wales-2011
select Middle Super Output Area (MSOA) data for England and Wales, and
...
```
    ...
    Rows: 7201 Columns: 17
    ── Column specification ────────────────────────────────────────────────────────
    Delimiter: ","
    chr  (4): GEO_CODE, GEO_LABEL, GEO_TYPE, GEO_TYP2
    dbl (13): Age : Age 16 to 74 - Travel to place of work; means of : Total\ Me...
...
Download msoa boundaries from https://geoportal.statistics.gov.uk and
read the shapefile with st_read.

This is the dataset we’ll use:
https://geoportal.statistics.gov.uk/datasets/8200e7683bba4de8a1a47e6b1c323099_0/explore?location=53.345186%2C-0.761311%2C15
...
```
     ...
     [1] "OBJECTID"      "MSOA11CD"      "MSOA11NM"      "MSOA11NMW"    
...
![](get-census-data_files/figure-commonmark/msoa-cycle-to-work-choropleth-ggplot2-1.png)

Next steps: try getting percent cycling in each zone, aggregate by local
authorities and regions, get 2021 data, improve the plot with better
colour scales, labels, etc.
